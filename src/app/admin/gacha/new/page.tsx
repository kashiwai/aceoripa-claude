...
export default function NewGachaPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    // 新規追加フィールド
    total_stock: 1000, // 総販売数
    is_free_points_only: false, // 無料ポイント専用
    required_user_rank: '', // 必要ユーザーランク
    // コスト計算用
    cost_per_card: 50, // カード原価（平均）
    ss_guarantee_threshold: 0.7, // 利益率がこれ以下でSS確定
    // 演出設定
    ss_animation_type: 'premium', // premium, special, normal
